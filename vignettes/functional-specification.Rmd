...
* New Input File on Azure: `wValidation wTestData.csv`
* `prediction-functions.R`
...
embed_png("images/rict-prediction-model-44.png", dpi = 140)
...
embed_png("images/rict-classification-model-44.png", dpi = 140)
...
|:--|:----------|:-------------------------------------------------------------|:----|
|1  |Primary    |RICT can complete the full nationalclassification in June 2019|    3|
