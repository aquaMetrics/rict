...
<!-- badges: start -->
[![R build status](https://github.com/aquaMetrics/rict/workflows/R-CMD-check/badge.svg)](https://github.com/aquaMetrics/rict/actions)
[![R build status](https://github.com/aquaMetrics/rict/workflows/test-coverage/badge.svg)](https://github.com/aquaMetrics/rict/actions)
...
An R package for calculating River Invertebrate Classification Tool (RICT) predictions. To use interactively via a [web app](https://rictapplications.shinyapps.io/rictapp/) - see the [User Guide](https://aquametrics.github.io/rict/articles/user-guide.html) for more details.
