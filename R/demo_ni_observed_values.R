#' Demo observed values for physical model in Northern Ireland
#'
#' A dataset containing demo observed values. Stored as .csv
#'     demo_ni_observed_values <- utils::read.csv(
#'      system.file("extdat", "ni-model-1-test-data.csv",
