...
1. [Download the validation template spreadsheet](https://github.com/aquaMetrics/rict/raw/master/inst/extdat/input-file-template.xlsx), this provides a helpful template for your input file. For reference and testing, the template spreadsheet also includes example data.
...
website](https://environment.data.gov.uk/explore/8d1422b3-c960-4ed9-a324-40eefb0c016e).
Follow these
